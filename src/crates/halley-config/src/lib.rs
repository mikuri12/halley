...
pub use layout::{
    ...
    CompositorGestureScope, ConfigPathSource, CursorActivation, CursorConfig, DebugConfig,
    DecorationBorderColor, DecorationsConfig, DeviceOverride, DeviceSettings,
    DynamicCursorConfig, DynamicCursorMode, DynamicRotateConfig, DynamicShakeConfig,
    DynamicStretchConfig, DynamicTiltConfig, EffectsConfig, ExpandedPlacementConfig,
