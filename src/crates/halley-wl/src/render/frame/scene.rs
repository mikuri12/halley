...
use smithay::{
    backend::renderer::{
        element::surface::render_elements_from_surface_tree, element::Kind, gles::GlesRenderer,
    },
    utils::{Physical, Rectangle},
};

use super::super::bearings::{collect_bearing_layouts, BearingChipLayout};
use super::super::cursor_surface_hotspot;
use super::super::layer_shell::{collect_layer_surfaces, LayerGroups};
use super::super::node::{collect_hover_preview, HoverPreviewCard, NodeSnapshot};
use super::super::pin_icon::PinBadgeLayout;
use super::super::state::ClosingWindowAnimationSnapshot;
use crate::compositor::interaction::ResizeCtx;
use crate::compositor::root::Halley;
use crate::window::{
    collect_active_surfaces, ActiveBorderRect, CroppedClippedSurfaceElement, DirectWindowBlurRect,
    OffscreenNodeTexture, StackWindowDrawUnit, WindowShadowRect,
};
...
pub(super) struct SceneCollections {
    ...
    /// When a fullscreen app is settled on the render monitor, the Top/Overlay
    /// layer-shell surfaces (bar, notifications, launcher) are skipped so the
    /// fullscreen covers them. See `current_monitor_has_settled_fullscreen`.
    pub(super) suppress_top_overlay_layers: bool,
}
...
pub(super) fn collect_debug_frame_scene(
    ...
    if crate::protocol::wayland::session_lock::session_lock_active(st) {
        ...
        return SceneCollections {
            ...
            // Screen locked: no fullscreen visible, don't suppress top layers.
            suppress_top_overlay_layers: false,
